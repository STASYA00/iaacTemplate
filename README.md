...
<div style="display:flex; flex:wrap; flex-direction: column; width:100%; justify-content:center; margin-top:30px">
    ...
    <div style="display:flex; flex:wrap; justify-content:space-around; --w:100%">
        ...
        <div style="display:flex; flex:wrap; flex-direction: column; width:30%; justify-content:center; ">
            ...
            <img src="https://www.iaacblog.com/wp-content/uploads/2019/10/5-2-730x730.jpg" alt="Serjoscha Düring" width=250 style="filter: grayscale(100%);"></a>
        ...
        <div style="display:flex; flex:wrap; flex-direction: column; width:30%; justify-content:center;">
            ...
            <img src="https://media.licdn.com/dms/image/C4D03AQF595KPmlY2XA/profile-displayphoto-shrink_800_800/0/1663951677012?e=1691020800&v=beta&t=jFRN_EsKThcL3ObyotLuuvh7ZL_Bg4QwqXFD2JuaCZw" alt="Stasja Fedorova" width=250 style="filter: grayscale(100%);"></a>
